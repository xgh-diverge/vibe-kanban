...
SELECT electric_sync_table('public', 'issue_dependencies');
...
CREATE INDEX IF NOT EXISTS idx_issue_dependencies_blocking_issue_id ON issue_dependencies(blocking_issue_id);
